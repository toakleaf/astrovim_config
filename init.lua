...
local config = {
  ...
  highlights = {
    ...
    default_theme = function(highlights) -- or a function that returns a new table of colors to set
      ...
      highlights.TreesitterContext = { fg = C.fg, bg = "#181a1f" }
      return highlights
    end,
  },
  ...
  plugins = {
    init = {
      ...
      -- You can also add new plugins hereas well:
    ...
    aerial = {
      on_attach = function(bufnr)
        ...
        vim.keymap.set("n", "<C-[>", "<cmd>AerialPrev<cr>", { buffer = bufnr, desc = "Jump backwards in Aerial" })
        vim.keymap.set("n", "<C-]>", "<cmd>AerialNext<cr>", { buffer = bufnr, desc = "Jump forwards in Aerial" })
